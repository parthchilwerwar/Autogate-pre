...
const innerDivVariants = cva(
  "w-full h-full flex items-center justify-center text-muted-foreground",
  {
    variants: {
      variant: {
        brand:
          "gap-2 bg-gradient-to-b from-[#d4ff2e] to-lime text-sm font-bold text-black1 transition duration-300 ease-in-out hover:from-[#dbff52] hover:to-[#bce800] active:from-lime active:to-[#9bbd00]",
        primary:
      ...
      size: {
        ...
        lg: "text-base rounded-[12px] px-4 py-2",
